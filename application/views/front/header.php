                           ...
                           <div class="tp-header-login d-none d-lg-block">
                              <a href="Login" class="d-flex align-items-center">
                                 ...
                                 <div class="tp-header-login-content d-none d-xl-block">
                                    <span>Hello,<?php echo $this->session->userdata('username') ?? 'CUSTOMER'; ?></span>
                               ...
                               <ul>
                                 <?php foreach($get_category_nav as $val): 
                                   ...
                                   <li class="has-dropdown">
                                      <a href="category/<?php echo $val->slug;?>" class="has-mega-menu">
                                        
                                      <?php echo $val->cate_name ;?></a>
                                            ...
                                            <li>
                                               ...
                                               <?php  $subcategory =$this->HomeModel->get_subcategory($val->cate_id); 
                                                foreach($subcategory as $subcat): ?>
                                                  ...
                                                  <li>
                                                     <a href="category/<?php echo $val->slug;?>/<?php echo $subcat->slug ;?>"> <?php echo $subcat->cate_name ;?></a>
                                                  </li>
                                    ...
                                    <?php else: ?>
                                        <li>
                                        <a href="category/<?php echo $val->slug ;?>">
